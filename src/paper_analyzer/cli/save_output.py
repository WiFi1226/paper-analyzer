...
保存 Agent 分析结果到 _outputs/ 目录。

用法:
    paper-save-output <agent_name> <paper_name> <output.md> -o _outputs/
...
def main() -> None:
    ...
    parser.add_argument("-o", "--output-dir", default=None, help="输出根目录（默认 output/<论文名>/cache/_outputs/）")
